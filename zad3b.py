...
plt.pie(dane_ax2['Ilość'], labels=labels, autopct='%1.0f%%', explode=[0, 0, 0.1, 0, 0])
plt.title("Ilość poszczególnych kategorii hoteli w roku 2019")
plt.savefig("zad3b.jpg", format='jpg')
plt.show()
